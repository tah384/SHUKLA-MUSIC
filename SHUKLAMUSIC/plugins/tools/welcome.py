...
from SHUKLAMUSIC.utils.Shukla_ban import *
...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("SHUKLAMUSIC/assets/WELL2.PNG")
    ...
    font = ImageFont.truetype('SHUKLAMUSIC/assets/font.ttf', size=75)
...
[
[InlineKeyboardButton(f"ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ", url=f"https://t.me/DevilXmusicrobot?startgroup=new"),
]
]
))
