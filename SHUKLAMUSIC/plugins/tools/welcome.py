...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    #
    draw.text((1770, 1015), f'NAME: {user}', fill=(255, 0, 0), font=font)
    draw.text((1530, 1230), f'ID: {id}', fill=(0, 0, 139), font=font)
#    draw.text((630, 150), f"{chatname}", fill=(225, 225, 225), font=welcome_font)
    draw.text((2030, 1450), f"USERNAME : {uname}", fill=(255, 255, 255), font=font)
